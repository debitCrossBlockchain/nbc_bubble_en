...
namespace SunManage.AllCheck
{
    public partial class BasicBubblePoint : Form
    {
       ...
       static int x = 0;
        ...
        /// Result
        /// </summary>
        static string Test_type="Basic Bubble Point";
        ...
        private void BasicBubblePointPTime(ZedGraphControl zgc)
        {
            ...
            myPane.Title.Text = "Basic Bubble Point Chart";
            ...
            try
            {
                ...
                foreach (CommPort o in CommPort.MCurrent)
                {
                    ...
                    {
                        if ((o.CurrentState == 0x52) && (o.CurrentType == "Basic Bubble Point"))
                        {
            ...
            foreach (CommPort oR in CommPort.MResult)
            {
                ...
                {
                    if  ( oR.CurrentType== "Basic Bubble Point")
                    {
        ...
        private void BasicBubblePointFP(ZedGraphControl zgc)
        {
            ...
            // set the titles and axis labels
            myPane.Title.Text = "Basic Bubble PointChart";
        ...
        private void BasicBubblePoint_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tabControlBasicBubblePoint.SelectTab(tabPageBasicBubblePointset);//set为当前的选项卡
        ...
        private void buttontabPageBasicBubblePointsetTest_Click(object sender, EventArgs e)
        {
            ...
            //            string mQuery = "update [BBStartTest] set [DeviceName]='" + mTreeName.ToString() + "',[Htest_type]='" + "Basic Bubble Point".ToString() + "',[Test_Psernum]='" + textBoxTest_Psernum.Text.ToString() + "',[Test_Tsernum]='" + textBoxTest_Tsernum.Text.ToString() + "',[Test_Fsernum]='" + textBoxTest_Fsernum.Text.ToString() + "',[Test_filt]='" + textBoxTest_filt.Text.ToString() + "',[Test_LIQU]='" + mLiqu.ToString() + "',[HA_STime]='" + DTime + "',[Test_LIQUType]='" + textBoxTest_LIQU.Text.ToString() + "',[Test_LIQUConsistence]='" + HTest_LIQUConsistenceBP.ToString() + "',[Test_Filter_type]='" + textBoxTest_Filter_Config.Text.ToString() + "',[Test_Filter_Config]='" + HTest_Filter_ConfigBP.ToString() + "',[Test_Filter_Area]='" + textBoxTest_Filter_Area.Text.ToString() + "',[Test_Meme_Aper]='" + textBoxTest_Meme_Aper.Text.ToString() + "',[Test_Velocity]='" + mTVelocity.ToString() + "',[Test_Up_Volm]='" + ("").ToString() + "',[Test_startp]='" + textBoxTest_startp.Text.ToString() + "',[Test_setBp]='" + textBoxTest_setBp.Text.ToString() + "',[Test_Dif_max]='" + ("").ToString() + "' where [DeviceName]='" + mTreeName.ToString() + "'";
            ...
            try
            {
                ...
                this.tabControlBasicBubblePoint.SelectTab(tabPageBasicBubblePointState);//setState为当前的选项卡
            }
            catch (Exception er)
            {
                MessageBox.Show(er.Message);
        ...
        {
            DialogResult dr = MessageBox.Show(" Are you sure you want to save the Basic Bubble Point results?", "Tips", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void pictureBoxChart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tabControlBasicBubblePoint.SelectTab(tabControlBasicBubblePointChart);//set为当前的选项卡
            }
            catch (Exception ex)
            {
                MessageBox.Show("Exception:" + ex.ToString(), "Tips");
        ...
        private void pictureBoxSave_MouseEnter(object sender, EventArgs e)
        {
            ...
            p.ShowAlways = true;
            p.SetToolTip(this.pictureBoxSave, "Save Base.BP Result");
        ...
        private void pictureBoxPrint_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxPrint, "Print Base.BP Result");
        ...
        private void pictureBoxChart_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxChart, "See Basic Bubble Point Chart");
        ...
        private void textBoxTest_Filter_Config_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    case "Cartridge":
                        Test_Filter_ConfigBP = Cartridge.Test_filter_Hight;
                        Test_Filter_numerBP = Cartridge.Test_filter_Num;
                        break;
                    case "Pannel":
