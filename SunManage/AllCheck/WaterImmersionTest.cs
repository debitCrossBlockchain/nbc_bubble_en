...
namespace SunManage.AllCheck
{
    public partial class WaterImmersionTest : Form
    {
        ...
        private void WaterImmersionTestPTime(ZedGraphControl zgc)
        {
            ...
            myPane.Title.Text = "Water Immersion  Chart";
            ...
            try
            {
                ...
                foreach (CommPort o in CommPort.MCurrent)
                {
                    ...
                    {
                        if ((o.CurrentState == 0x52) && (o.CurrentType == "Water Immersion "))
                        {
            ...
            LineItem curve = myPane.AddCurve("Pressure and Time", list1, Color.Red, SymbolType.None);
            ...
            foreach (CommPort oR in CommPort.MResult)
            {
                ...
                {
                    if (oR.CurrentType == "Water Immersion ")
                    {
        ...
        private void WaterImmersionTest_Load(object sender, EventArgs e)
        {
            ...
            this.tabControlWaterImmersionTest.SelectTab(tabPageWaterImmersionTestset);//set为当前的选项卡
        ...
        private void buttontabPageWaterImmersionTestsetTest_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                try
                {
                    ...
                    if (mStartTest == true)
                    {
                        string mQuery = String.Format("INSERT INTO {0}([DeviceName],[Htest_type],[Test_Psernum],[Test_Tsernum],[Test_Fsernum],[Test_filt],[Test_LIQU],[HA_STime],[Test_LIQUType],[Test_LIQUConsistence],[Test_Filter_type],[Test_Filter_Config],[Test_Filter_number],[Test_Filter_Area],[Test_Meme_Aper],[Test_Velocity],[Test_Up_Volm],[Test_startp],[Test_setBp],[Test_Dif_max]) VALUES ('" + mTreeName + "','" + "Water Immersion ".ToString() + "','" + textBoxTest_Psernum.Text.ToString() + "','" + textBoxTest_Tsernum.Text.ToString() + "','" + textBoxTest_Fsernum.Text.ToString() + "','" + textBoxTest_filt.Text.ToString() + "','" + mLiqu.ToString() + "','" + DTime + "','" + textBoxTest_LIQU.Text.ToString() + "','" + HTest_LIQUConsistenceWT.ToString() + "','" + textBoxTest_Filter_Config.Text.ToString() + "','" + HTest_Filter_ConfigWT.ToString() + "','" + HTest_Filter_numerWT.ToString() + "','" + textBoxTest_Filter_Area.Text.ToString() + "','" + textBoxTest_Meme_Aper.Text.ToString() + "','" + textBoxTest_Velocity.Text.ToString() + "','" + textBoxTest_Up_Volm.Text.ToString() + "','" + textBoxTest_startp.Text.ToString() + "','" + ("").ToString() + "','" + textBoxTest_Dif_max.Text.ToString() + "')", ("WIStartTest").ToString());
            ...
            this.tabControlWaterImmersionTest.SelectTab(tabPageWaterImmersionTestState);//setState为当前的选项卡
        }
        ...
        /// <summary>
        /// 保存Water浸入Test result到数据库
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void pictureBoxSave_Click(object sender, EventArgs e)
        {
            DialogResult dr = MessageBox.Show("Do you want Confirm to save Water and dip it into Test result?", "Tips", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            string m1 = "";
            string m2 = "";
            string m3 = "";
            string m4 = "";
            ...
            if (DialogResult.Yes == dr)
            {
                ...
                if (!string.IsNullOrEmpty(mTreeName))
                {
                    ...
                    string mQuery = "Select TestHisData as 'NO.',Test_Psernum as 'Production batch.',HA_STime as 'Test Time',Htest_type as 'Test Type' From {0}";
        ...
        /// <summary>
        /// 查看Water Immersion 当前Testing Chart
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void pictureBoxChart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tabControlWaterImmersionTest.SelectTab(tabPageWaterImmersionTestChart);//set为当前的选项卡
            }
            catch (Exception ex)
            {
                MessageBox.Show("Exception:" + ex.ToString(), "Tips");
        ...
        private void pictureBoxSave_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxSave, "Save Water and immerse in Test result！");
        ...
        private void pictureBoxPrint_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxPrint, "Print Water and immerse Test result!");
        ...
        private void pictureBoxChart_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxChart, "See Water Immersion  Chart!");
        ...
        private void textBoxTest_Filter_Config_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case "Cartridge":
                        Test_Filter_ConfigWT = Cartridge.Test_filter_Hight;
                        Test_Filter_numerWT = Cartridge.Test_filter_Num;
                        break;
                    case "Pannel":
