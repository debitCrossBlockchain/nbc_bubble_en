    ...
    public partial class StrengthenTheBubble : Form
    {
       ...
       public static   StrengthenTheBubble MStrengthenTheBubble = null;
        ...
        private void BasicBubblePointPTime(ZedGraphControl zgc)
        {
            ...
            myPane.Title.Text = "Extensive Bubble Point Chart";
            ...
            try
            {
                ...
                foreach (CommPort o in CommPort.MCurrent)
                {
                    ...
                    {
                        if ((o.CurrentState == 0x52) && (o.CurrentType == "Extensive Bubble Point"))
                        {
            ...
            foreach (CommPort oR in CommPort.MResult)
            {
                ...
                {
                    if (oR.CurrentType == "Extensive Bubble Point")
                    {
        ...
        private void BasicBubblePointFP(ZedGraphControl zgc)
        {
            ...
            // set the titles and axis labels
            myPane.Title.Text = "Extensive Bubble PointChart";
        ...
        private void StrengthenTheBubble_Load(object sender, EventArgs e)
        {
            ...
            this.tabControlStrengthenTheBubble.SelectTab(tabPageStrengthenTheBubbleset);//set为当前的选项卡
            //实例化xml
            XmlDocument xml = new XmlDocument();
            //读取xml文件
            xml.Load(@"..\..\XmlIni\StartTheTestData.XML");  //xml地址
        ...
        private void buttontabPageStrengthenTheBubblesetTest_Click(object sender, EventArgs e)
        {
            ...
            this.tabControlStrengthenTheBubble.SelectTab(tabPageStrengthenTheBubbleState);//setState为当前的选项卡
        }
        ...
        {
            CommPort mComPort = CommPort.Instance;
            if ((mComPort.DeviceAddress1 == CommPort.mDeviceAddress) && (mComPort.StateTest_type1 == "Extensive Bubble Point"))
            {
        ...
        {
            DialogResult dr = MessageBox.Show("Do you want to save Confirm Result enhanced bubble?", "Tips", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            string m1 = "";
            string m2 = "";
            string m3 = "";
            string m4 = "";
        ...
        private void pictureBoxChart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tabControlStrengthenTheBubble.SelectTab(tabPageStrengthenTheBubbleChart);//set为当前的选项卡
            }
            catch (Exception ex)
            {
                MessageBox.Show("Exception:" + ex.ToString(), "Tips");
        ...
        /// <summary>
        /// 查看Extensive Bubble PointChartTips
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        private void pictureBoxChart_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxChart, "See Extensive Bubble Point Chart");
        ...
        private void pictureBoxSave_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxSave, "Save Extensiv.BP Result");
        ...
        private void pictureBoxPrint_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxPrint, "Print Extensiv.BP Result");
        ...
        private void textBoxTest_Filter_Config_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case "Cartridge":
                        Test_Filter_ConfigSP = Cartridge.Test_filter_Hight;
                        Test_Filter_numerSP = Cartridge.Test_filter_Num;
                        break;
                    case "Pannel":
