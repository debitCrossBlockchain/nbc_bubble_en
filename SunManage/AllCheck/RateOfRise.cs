...
namespace SunManage.AllCheck
{
    public partial class RateOfRise : Form
    {
        ...
        private void RateOfRisePTime(ZedGraphControl zgc)
        {
            ...
            myPane.Title.Text = "Pressure Holding Chart";
            ...
            try
            {
                ...
                foreach (CommPort o in CommPort.MCurrent)
                {
                    ...
                    {
                        if ((o.CurrentState == 0x52) && (o.CurrentType == "Pressure Holding"))
                        {
            ...
            foreach (CommPort oR in CommPort.MResult)
            {
                ...
                {
                    if (oR.CurrentType == "Pressure Holding")
                    {
        ...
        private void RateOfRiseFP(ZedGraphControl zgc)
        {
            ...
            // set the titles and axis labels
            myPane.Title.Text = "Pressure HoldingChart";
        ...
        private void RateOfRise_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.tabControlRateOfRise.SelectTab(tabPageRateOfRiseset);//set为当前的选项卡
        ...
        private void buttontabPageRateOfRisesetTest_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                try
                {
                    ...
                    if (mStartTest == false)
                    {
                        ...
                        string mQuery = "update [RRStartTest] set [DeviceName]='" + mTreeName.ToString() + "',[Htest_type]='" + "Pressure Holding".ToString() + "',[Test_Psernum]='" + textBoxTest_Psernum.Text.ToString() + "',[Test_Tsernum]='" + textBoxTest_Tsernum.Text.ToString() + "',[Test_Fsernum]='" + textBoxTest_Fsernum.Text.ToString() + "',[Test_filt]='" + textBoxTest_filt.Text.ToString() + "',[Test_LIQU]='" + mLiqu.ToString() + "',[HA_STime]='" + DTime + "',[Test_LIQUType]='" + "" + "',[Test_LIQUConsistence]='" + HTest_LIQUConsistenceRR.ToString() + "',[Test_Filter_type]='" + textBoxTest_Filter_Config.Text.ToString() + "',[Test_Filter_Config]='" + HTest_Filter_ConfigRR.ToString() + "',[Test_Filter_Area]='" + textBoxTest_Filter_Area.Text.ToString() + "',[Test_Meme_Aper]='" + textBoxTest_Meme_Aper.Text.ToString() + "',[Test_Velocity]='" + textBoxTest_Velocity.Text.ToString() + "',[Test_Up_Volm]='" + ("").ToString() + "',[Test_startp]='" + textBoxTest_startp.Text.ToString() + "',[Test_setBp]='" + ("").ToString() + "',[Test_Dif_max]='" + ("").ToString() + "' where [DeviceName]='" + mTreeName.ToString() + "'";
            ...
            this.tabControlRateOfRise.SelectTab(tabPageRateOfRiseState);//setState为当前的选项卡
        }
        ...
        private void pictureBoxChart_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.tabControlRateOfRise.SelectTab(tabPageRateOfRiseChart);//set为当前的选项卡
            }
            catch (Exception ex)
            {
                MessageBox.Show("Exception:" + ex.ToString(), "Tips");
        ...
        private void pictureBoxSave_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxSave, "Save Pressure Holding Result");
        ...
        private void pictureBoxPrint_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxPrint, "Print Pressure Holding Result");
        ...
        private void pictureBoxChart_MouseEnter(object sender, EventArgs e)
        {
            try
            {
                ...
                ToolTip p = new ToolTip();
                p.ShowAlways = true;
                p.SetToolTip(this.pictureBoxChart, "See Pressure Holding Chart");
        ...
        private void textBoxTest_Filter_Config_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    case "Cartridge":
                        Test_Filter_ConfigRR = Cartridge.Test_filter_Hight;
                        Test_Filter_numerRR = Cartridge.Test_filter_Num;
                        break;
                    case "Pannel":
